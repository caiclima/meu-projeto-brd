 ...
 */
@Entity
@Table(name = "TB_NUVEM_VENDAS_REGISTRO_HEADER_PPLUS")
public class NuvemVendasRegistroHeaderPplus implements IdentifiableEntity<Long>, Serializable {
    ...
    public NuvemVendasRegistroHeaderPplus() {
    }

    public NuvemVendasRegistroHeaderPplus(Long id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof NuvemVendasRegistroHeaderPplus)) {
            return false;
        }
        NuvemVendasRegistroHeaderPplus other = (NuvemVendasRegistroHeaderPplus) object;
    ...
    public String toString() {
        return "br.com.callink.bradesco.seguro.entity.NuvemVendasRegistroHeaderPplus[ id=" + id + " ]";
    }
